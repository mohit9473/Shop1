...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(7, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.snacks));
        allCategoryModelList.add(new AllCategoryModel(9, R.drawable.snacks));
